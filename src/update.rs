...
// impl FromStr for TransactionT {
//     type Err = ();

//     fn from_str(input: &str) -> Result<TransactionT, Self::Err> {
//         match input {
//             "mint" => Ok(TransactionT::Mint),
//             "transfer" => Ok(TransactionT::Transfer),
//             "view" => Ok(TransactionT::View),
//             _ => Err(()),
//         }
//     }
// }

// impl fmt::Debug for TransactionT {
